    ...
    <div class="logo-container">
      <div class="logo-icon-wrapper">
        <svg
          ...
          class="logo-icon"
        >
          <path d="M71.38 127C72.9165 130.558 74.1541 134.237 75.08 138C77.78 149 67.68 151.35 67.68 151.35L56.42 132.66L36.65 127.09C36.65 127.09 38.41 116.45 47.25 116.83C50.86 116.98 54.85 117.36 58.31 117.76C60.89 113.87 64.25 108.76 67.86 103.45L34.86 92.1303C34.86 92.1303 36.86 75.8703 53.96 79.5603C61.15 81.1103 72.2 83.3003 80.57 84.9303C83.42 80.9303 85.97 77.4403 87.92 75.0103C96 65.0003 108.73 57.0803 113.19 60.6503C117.65 64.2203 114 78.8703 105.89 89.0003C100 96.4403 81.13 116.64 71.38 127ZM109.8 123.19C116 136.08 101 144.59 101 144.59L86.37 121.59L100.65 104.46C103.73 110.7 107.09 117.62 109.8 123.23V123.19Z" />
        </svg>
      </div>
